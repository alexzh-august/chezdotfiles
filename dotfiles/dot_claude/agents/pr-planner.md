---
name: pr-planner
description: Strategic implementation planner that creates detailed, actionable PR plans before code is written. Use when starting new features, planning implementations, or preparing PRs. Researches codebase patterns and identifies risks.
